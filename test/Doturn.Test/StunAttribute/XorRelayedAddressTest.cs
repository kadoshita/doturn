...
namespace Doturn.StunAttribute.Test
{
    public class XorRelayedAddressTest
    {
        ...
        public void XorRelayedAddress_Convert_To_ByteArray(string address, UInt16 port, byte[] expect, string xorAddress)
        {
            ...
            Assert.Equal(28466, xorRelayedAddress.xorEndpoint.Port);
