...
namespace Doturn.StunMessage.Test
{
    public class StunMessageParserTest
    {
        ...
        private readonly byte[] createPermissionRequestBytes = new byte[] {
        ...
        private readonly byte[] refreshRequestBytes = new byte[] {
        ...
        private readonly byte[] unknownRequestBytes = new byte[] {
        ...
        {
            var result = (Binding)StunMessageParser.Parse(this.bindingRequestBytes);
        ...
        {
            var result = (Allocate)StunMessageParser.Parse(this.allocateRequestBytes);
        ...
        {
            var result = (CreatePermission)StunMessageParser.Parse(this.createPermissionRequestBytes);
        ...
        {
            var result = (Refresh)StunMessageParser.Parse(this.refreshRequestBytes);
        ...
        {
            Assert.Throws<StunMessageParseException>(() => StunMessageParser.Parse(this.unknownRequestBytes));
        }
    }
}